...
class Router {
    ...
    handleRoute() {
        ...
        // Simple parameter parsing: #game-detail?name=GameName
        let routeKey = hash;
        let params = null;
